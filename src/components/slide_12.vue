  ...
  >
    ...
    <div class='popup'>
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_12/person_1.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_12.founder') }}</div>
            <div><b>{{ t('slide_12.founder_name') }}</b></div>
          </div>
      ...
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_12/person_2.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_12.staff') }}</div>
            <div><b>{{ t('slide_12.staff_name') }}</b></div>
          </div>
      ...
      <div class='address' v-html='t("slide_12.address")' />
    </div>
  </article>
