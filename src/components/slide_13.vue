  ...
  >
    ...
    <div class='popup'>
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_13/person_1.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_13.founder') }}</div>
            <div><b>{{ t('slide_13.founder_name') }}</b></div>
          </div>
      ...
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_13/person_2.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_13.staff') }}</div>
            <div><b>{{ t('slide_13.staff_name') }}</b></div>
          </div>
      ...
      <div class='address' v-html='t("slide_13.address")' />
    </div>
  </article>
