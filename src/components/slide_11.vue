  ...
  >
    ...
    <div class='popup'>
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_11/person_1.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_11.founder') }}</div>
            <div><b>{{ t('slide_11.founder_name') }}</b></div>
          </div>
      ...
      <div class='person'>
        <img
          loading='lazy'
          src='../assets/slide_11/person_2.png'
        >

        <div class='info'>
          <div class='name'>
            <div>{{ t('slide_11.staff') }}</div>
            <div><b>{{ t('slide_11.staff_name') }}</b></div>
          </div>
      ...
      <div class='address' v-html='t("slide_11.address")' />
    </div>
  </article>
